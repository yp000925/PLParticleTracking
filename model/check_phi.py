...
class PLholonet_block(nn.Module):
    ...
    def Phi_update(self,x,z,u1,u2,otf3d, K1,K0):
        ...
        # func2 = lambda y: K0-K1/(torch.exp(y)-1)
        ...
        for i in range(30):
            ...
            # plot_img(img,'iter%s'%str(i),fig_name='./phi_update/tmp_'+str(i)+'.png',show=False,cmap='Greys')
            ...
            # if not os.path.isdir('./phi_update/'):
            #     os.makedirs('./phi_update/')
            # plot_img(img,'iter%s'%str(i),fig_name='./phi_update/phi_'+str(i)+'.png',show=False,cmap='Greys')
