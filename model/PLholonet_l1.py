...
major difference:
use the l1 proximal operator for z-update
"""
...
import os
class PLholonet_l1_block(nn.Module):
    def __init__(self, verboseFlag = False):
        super(PLholonet_l1_block, self).__init__()
...
class PLholonet_l1(nn.Module):
    def __init__(self,n,d,verboseFlag = False):
        super(PLholonet_l1, self).__init__()
        self.n = n
        self.blocks = nn.ModuleList([])
        for i in range(n):
            self.blocks.append(PLholonet_l1_block())
...
if __name__ == "__main__":
    ...
    model = PLholonet_l1(n=5, d=25,verboseFlag=True)
