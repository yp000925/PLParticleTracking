...
This is for the model of phase retrieval
"""
...
class PLPhaseNet_block(nn.Module):
    def __init__(self, verboseFlag = False):
        super(PLPhaseNet_block, self).__init__()
...
class PLPhasenet(nn.Module):
    def __init__(self,n,sysloss_param = 2e-2,verboseFlag = False):
        ...
        for i in range(n):
            self.blocks.append(PLPhaseNet_block())
